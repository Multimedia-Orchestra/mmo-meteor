function Project(name, iconUrlRel, maker, description, images) {
    ...
    //      "P.R.I.M.E" -> "prime"
    //
    // A project's page (i.e. /projects/gravity) will load a template with name == id
...
Template.projectsTemplate.projects = [
    new Project("P.R.I.M.E.", "prime2.jpg", "Kevin Gutowski", "PRIME or (Physics-Based Responses in a Musical Environment) is an interactive, musical projection controlled by a gesture-tracking camera.", ["prime1.jpg", "prime2.jpg"]),

    new Project( "SoundScreen",  "soundscreen1.jpg",  "Taurin Barrera", "The SoundScreen is a depth-sensitive spandex surface that can be explored musically and visually.", ["soundscreen1.jpg", "soundscreen2.jpg"]),
    ...
    new Project( "L.E.D. Matrix",  "ledmatrix1.jpg",  "Michael Williams", "The L.E.D matrix is a grid of sound-responsive LED lights. The project involved writing and documenting a custom OSC to SPI communication library.", ["ledmatrix1.jpg"]),

    new Project( "Laser Harp",  "laserharp1.jpg",  "Eugene Lynch", "Eugene's laser harp is a custom designed laser sensor system. The 'strings' of the laser harp trigger visual and audio samples.", ["laserharp1.jpg", "laserharp2.jpg"]),
    ...
    new Project( "Blind Bullets Sleep Talking",  "sculpture1.jpg",  "Demart Denaro", "Blind Bullets Sleep Talking is an interactive, kinectic sound sculpture made with hand-carved bullets, a wine rack, and nylon threads.", ["sculpture1.jpg", "sculpture2.jpg"]),
