...
Template.projectsTemplate.projects = [
    ...
    new Project( "SoundScreen",  "soundscreen1.jpg",  "Taurin Barrera", "The SoundScreen a depth sensitive spandex surface that can be explored musically and visually.", ["soundscreen1.jpg", "soundscreen2.jpg"]),
    ...
    new Project( "L.E.D. Matrix",  "ledmatrix1.jpg",  "Michael Williams", "The L.E.D matrix is a grid of sound responsive LED lights. The project involved writing and doccumenting a custom OSC to SPI communication library.", ["ledmatrix1.jpg"]),
